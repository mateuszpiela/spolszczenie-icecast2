	...
	<xsl:for-each select="source">
		<xsl:if test = "listeners!=''"> 
			<div class="roundbox">
				...
				<div class="mountcont">
					<ul class="nav">
						<li><a href="listclients.xsl?mount={@mount}">Lista Klientów</a></li>
						...
						<xsl:if test="authenticator">
							<li><a href="manageauth.xsl?mount={@mount}">Zarządzaj Autoryzowanie</a></li>
						</xsl:if>
